                                            ...
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        ...
                                                        <h3 class="text-white">{{ $tot_per_bln['rpl']['masuk'] }}</h3>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        ...
                                                        <h3 class="text-white">{{ $tot_per_bln['rpl']['diterima'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i
                                            ...
                                            <div class="card-body ">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        ...
                                                        <h3 class="text-white">{{ $tot_per_bln['rpl']['ditolak'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        <span>Permohonan Masuk</span>
                                                        <h3 class="text-white">{{ $tot_per_bln['rpb']['masuk'] }}</h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i class="la la-paste font-large-2 float-right text-white"></i>
                                                    </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        <span>Permohonan Diterima</span>
                                                        <h3 class="text-white">{{ $tot_per_bln['rpb']['diterima'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i
                                        ...
                                        <div class="card-content">
                                            <div class="card-body ">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        <span>Permohonan Ditolak</span>
                                                        <h3 class="text-white">{{ $tot_per_bln['rpb']['ditolak'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i class="icon-close font-large-2 float-right text-white"></i>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        <span>Permohonan Masuk</span>
                                                        <h3 class="text-white">{{ $tot_per_thn['rpl']['masuk'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i class="la la-paste font-large-2 float-right text-white"></i>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        <span>Permohonan Diterima</span>
                                                        <h3 class="text-white">{{ $tot_per_thn['rpl']['diterima'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i
                                        ...
                                        <div class="card-content">
                                            <div class="card-body ">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        <span>Permohonan Ditolak</span>
                                                        <h3 class="text-white">{{ $tot_per_thn['rpl']['ditolak'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i class="icon-close font-large-2 float-right text-white"></i>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        <span>Permohonan Masuk</span>
                                                        <h3 class="text-white">{{ $tot_per_thn['rpb']['masuk'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i class="la la-paste font-large-2 float-right text-white"></i>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        <span>Permohonan Diterima</span>
                                                        <h3 class="text-white">{{ $tot_per_thn['rpb']['diterima'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i
                                        ...
                                        <div class="card-content">
                                            <div class="card-body ">
                                                <div class="media d-flex">
                                                    <div class="media-body text-left text-white">
                                                        <span>Permohonan Ditolak</span>
                                                        <h3 class="text-white">{{ $tot_per_thn['rpb']['ditolak'] }}
                                                        </h3>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i class="icon-close font-large-2 float-right text-white"></i>
