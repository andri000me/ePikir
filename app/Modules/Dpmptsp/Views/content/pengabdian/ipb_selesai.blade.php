                    ...
                    <div class="dropdown float-md-right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
                            <a class="dropdown-item text-center"
                                href="{{ base_url('dpmptsp/pengabdian/selesai?status=3') }}">Disetujui</a>
                            <a class="dropdown-item text-center"
                                href="{{ base_url('dpmptsp/pengabdian/selesai?status=4') }}">Ditolak</a>
                            <a class="dropdown-item text-center"
                                href="{{ base_url('dpmptsp/pengabdian/selesai?status=5') }}">Semua</a>
                        </div>
                    </div>
                </div>
...
@push('js_script')
    <script>
        showDataTable("{{ base_url('dpmptsp/pengabdian/getdata/' . $status . '/tbl_data_rpb') }}",
            "{{ $status }}");
    </script>
