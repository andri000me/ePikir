...
class Pengabdian extends BaseController
{
    ...
    public function ipbMasuk()
    {
        ...
        return views('content/pengabdian/ipb_masuk', 'Dpmptsp', $this->v_data);
    }
    ...
    public function ipbProses()
    {
        ...
        return views('content/pengabdian/ipb_proses', 'Dpmptsp', $this->v_data);
    }
    ...
    public function ipbSelesai()
    {
        ...
        return views('content/pengabdian/ipb_selesai', 'Dpmptsp', $this->v_data);
    }
    ...
    public function getDataIpb($status = 1, $table = '')
    {
        ...
        if ($post) {
            ...
            foreach ($fetch_data as $row) {
                ...
                data-link="' . base_url('dpmptsp/pengabdian/hapusdata/' . encode($row->id_user_pemohon)) . '" 
                data-table="' . $table . '" 
