    ...
    <section id="hero-area" class="hero-area">
        ...
        <div class="slider-area">
            ...
            @foreach ($carousel as $item)
                <div class="single-slider" style="background-image:url('{{base_url('upload/slider/'.$item->file_carousel)}}')">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-md-6 col-12">
                                ...
                                <div class="slider-text">
                                    <div style="background:#ffffff94; padding: 20px">
                                        <h1>{{$item->judul_carousel}}</h1>
                                        <p>{{$item->ket_carousel}}</p>
                                    </div>
                            ...
                            {{-- <div class="col-lg-5 col-md-6 col-12">
                                ...
                                <div class="image-gallery">
                                    <div class="single-image">
                                        <img src="{{ assets_front }}images/slider/gallery-image1.jpg" alt="#">
                                    </div>
                                    <div class="single-image two">
                                        <img src="{{ assets_front }}images/slider/gallery-image2.jpg" alt="#">
                                    </div>
                                </div>
                                <!--/ End Image Gallery -->
                            </div> --}}
            ...
            {{-- <!--/ End Single Slider -->
            <!-- Single Slider -->
            <div class="single-slider slider-right" style="background-image:url('{{assets_front}}images/slider/slider-image2.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-6 col-12">
                            <!-- Image Gallery -->
                        ...
                        <div class="col-lg-7 col-md-6 col-12">
                            ...
                            <div class="slider-text text-right">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi laoreet urna ante, quis
                                    luctus nisi sodales sit amet. Aliquam a enim in massa molestie mollis Proin quis velit
                                    at nisl vulputate egestas non in arcu Proin a magna hendrerit, tincidunt neque sed. </p>
                                <div class="button">
            ...
            <!--/ End Single Slider -->
            <!-- Single Slider -->
            <div class="single-slider slider-center" style="background-image:url('{{assets_front}}images/slider/slider-image1.jpg')">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="single-progress">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" style="width: 78%" aria-valuenow="25"
                                            aria-valuemin="0" aria-valuemax="100"><span class="percent">78%</span></div>
                                    </div>
                                </div>
                                <!--/ End Single Skill -->
                            </div>
                                ...
                                <div class="single-progress">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" style="width: 80%" aria-valuenow="25"
                                            aria-valuemin="0" aria-valuemax="100"><span class="percent">80%</span></div>
                                    </div>
                                </div>
                                <!--/ End Single Skill -->
                            </div>
                                ...
                                <div class="single-progress">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" style="width: 90%" aria-valuenow="25"
                                            aria-valuemin="0" aria-valuemax="100"><span class="percent">90%</span></div>
                                    </div>
                                </div>
                                <!--/ End Single Skill -->
                            </div>
                                ...
                                <div class="single-progress">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" style="width: 95%" aria-valuenow="25"
                                            aria-valuemin="0" aria-valuemax="100"><span class="percent">95%</span></div>
                                    </div>
                                </div>
                                <!--/ End Single Skill -->
                            </div>
                            ...
                            <div class="cbp-item website animation printing">
                                <div class="portfolio-single">
                                    ...
                                    <div class="portfolio-hover">
                                        ...
                                        <div class="button">
                                            <a class="primary" data-fancybox="gallery" href="{{assets_front}}images/portfolio/p1.jpg"><i
                            ...
                            <div class="cbp-item website animation">
                                <div class="portfolio-single">
                                    ...
                                    <div class="portfolio-hover">
                                        ...
                                        <div class="button">
                                            <a class="primary" data-fancybox="gallery" href="{{assets_front}}images/portfolio/p3.jpg"><i
                                                    class="fa fa-search"></i></a>
                                            <a href="portfolio-single.html"><i class="fa fa-link"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="cbp-item development package">
                                <div class="portfolio-single">
                                    ...
                                    <div class="portfolio-hover">
                                        ...
                                        <div class="button">
                                            <a class="primary" data-fancybox="gallery" href="{{assets_front}}images/portfolio/p5.jpg"><i
                                                    class="fa fa-search"></i></a>
                                            <a href="portfolio-single.html"><i class="fa fa-link"></i></a>
                                        </div>
                                    </div>
