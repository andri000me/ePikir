            ...
            <div class="row">
                <div class="col-lg-8 col-12">
                    @if ($berita != null && $berita != '')
                        @if ($search != null || $select_kategori != null)
                            <div class="row nothing" style="padding-top: 31px;">
                                ...
                                <div class="col-md-4">
                                    <div class="button" style="margin-top: 0px;">
                                        <a class="btn primary w-100 float-right" href="{{ base_url('landing/berita') }}"
                            ...
                            <div class="col-lg-12 col-12 text-center">
                                <div class="shadow p-3 bg-white rounded"
                                    ...
                                    <h5 class="font-italic"><i class="fa fa-newspaper-o"></i>
                                        {{ $search != null ? 'Berita/artikel yang dicari tidak ditemukan.' : 'Belum ada berita/artikel yang diposting.' }}
                                    </h5>
                                    @if ($search != null)
                                        <div class="button">
                                            <a class="btn primary" href="{{ base_url('landing/berita') }}">Lihat Semua
                                                Berita</a>
                                        </div>
                                    @endif
                                </div>
