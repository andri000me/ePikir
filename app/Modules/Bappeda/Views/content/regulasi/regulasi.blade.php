        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-3 col-12 mb-2">
                    <a href="{{ base_url('bappeda/profil/regulasi/add') }}" class="btn btn-block btn-info"><i
                                                ...
                                                @foreach ($regulasi as $key => $val)
                                                    <tr>
                                                        ...
                                                        <td nowrap align="center">
                                                            <a href="{{ base_url('bappeda/profil/regulasi/edit/' . encode($val->id_regulasi)) }}"
                                                            ...
                                                            <button type="button" onclick="hapusData(this, true)"
                                                                data-link="{{ base_url('bappeda/profil/regulasi/delete/' . encode($val->id_regulasi)) }}"
                                                                class="btn btn-sm btn-danger" title="Hapus Data"><i
                                                                    class="la la-trash-o font-small-3"></i></button>
                                                        </td>
                                                        <td nowrap>{{ $val->nama_regulasi }}</td>
                                                        <td>{{ $val->isi_regulasi }}</td>
                                                        <td align="center"><a href="javascript:void(0)"
                                                                data-source="{{ base_url('upload/regulasi/' . $val->file_regulasi) }}"
