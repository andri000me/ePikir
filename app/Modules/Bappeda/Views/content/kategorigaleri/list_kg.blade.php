        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-3 col-12 mb-2">
                    <a href="{{ base_url('bappeda/kategorigaleri/add') }}" class="btn btn-block btn-info"><i
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered" id="list_tbl">
                                            ...
                                            <tbody>
                                                @foreach ($kg as $key => $val)
                                                    <tr>
                                                        <td align="center" width="50">{{ $key + 1 }}</td>
                                                        <td nowrap align="center" width="100">
                                                            <a href="{{ base_url('bappeda/kategorigaleri/edit/' . encode($val->id_kg)) }}"
                                                            ...
                                                            <button type="button" onclick="hapusData(this, true)"
                                                                data-link="{{ base_url('bappeda/kategorigaleri/delete/' . encode($val->id_kg)) }}"
...
@push('js_script')
    ...
    <script>
        function changeActive(data) {
            ...
            $.get("{{ base_url('bappeda/kategorigaleri/active/') }}/" + act + '/' + id,
                function(dt) {
