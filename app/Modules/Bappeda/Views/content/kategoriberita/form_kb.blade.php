        ...
        <div class="content-wrapper">
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ base_url('bappeda/kategoriberita') }}">Kategori
                                        Berita</a>
                                </li>
                ...
                <div class="content-header-right col-md-2 col-12 mb-2">
                    <a href="{{ base_url('bappeda/kategoriberita') }}" class="btn btn-block btn-primary"><i
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        {!! form_open_multipart(base_url('bappeda/kategoriberita/save'), 'class="form" id="formInputKb"') !!}

                                        <div class="row">
                                            <div class="col-md-9">
                                                <input type="hidden" name="id_kb"
                                                    value="{{ isset($kb) && $kb != null ? encode($kb->id_kb) : '' }}">

                                                <div class="form-group">
                                                    <label>Nama Kategori</label>
                                                    <input type="text" name="nama_kategori" class="form-control"
                                                        placeholder="Isi nama kategori berita"
                                                        value="{{ isset($kb) && $kb != null ? $kb->nama_kategori : '' }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
