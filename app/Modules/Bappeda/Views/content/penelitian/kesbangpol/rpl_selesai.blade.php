                    ...
                    <div class="dropdown float-md-right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
                            <a class="dropdown-item text-center"
                                href="{{ base_url('bappeda/penelitian/kesbangpol/selesai?status=3') }}">Disetujui</a>
                            <a class="dropdown-item text-center"
                                href="{{ base_url('bappeda/penelitian/kesbangpol/selesai?status=4') }}">Ditolak</a>
                            <a class="dropdown-item text-center"
                                href="{{ base_url('bappeda/penelitian/kesbangpol/selesai?status=5') }}">Semua</a>
                        </div>
                    </div>
                </div>
...
@push('js_script')
    <script>
        showDataTable("{{ base_url('bappeda/penelitian/kesbangpol/getdata/' . $status . '/tbl_data_rpl') }}",
            "{{ $status }}");
    </script>
    ...
    <script>
        ...
        function cetakSuratRpl() {
            ...
            window.open("{{ base_url('bappeda/penelitian/kesbangpol/cetak') }}?id=" + id + "&&idp=" + idp + "&&tgl=" +
                tgl);
...
@include('content.penelitian.kesbangpol.modal_detail')
