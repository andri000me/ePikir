        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-3 col-12 mb-2">
                    <a href="{{ base_url('bappeda/publikasi/info/add') }}" class="btn btn-block btn-info"><i
                                                ...
                                                @foreach ($info as $key => $val)
                                                    <tr>
                                                        ...
                                                        <td nowrap align="center">
                                                            <a href="{{ base_url('bappeda/publikasi/info/edit/' . encode($val->id_info)) }}"
                                                            ...
                                                            <button type="button" onclick="hapusData(this, true)"
                                                                data-link="{{ base_url('bappeda/publikasi/info/delete/' . encode($val->id_info)) }}"
                                                                class="btn btn-sm btn-danger" title="Hapus Data"><i
                                                                    class="la la-trash-o font-small-3"></i></button>
                                                        </td>
                                                        <td nowrap>{{ $val->nama_info }}</td>
                                                        <td>{{ $val->isi_info }}</td>
                                                        <td align="center"><a href="javascript:void(0)"
                                                                data-source="{{ base_url('upload/info/' . $val->file_info) }}"
