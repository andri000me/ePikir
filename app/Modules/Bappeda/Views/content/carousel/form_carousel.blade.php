        ...
        <div class="content-wrapper">
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ base_url('bappeda/carousel') }}">Carousel</a></li>
                ...
                <div class="content-header-right col-md-2 col-12 mb-2">
                    <a href="{{ base_url('bappeda/carousel') }}" class="btn btn-block btn-primary"><i
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        {!! form_open_multipart(base_url('bappeda/carousel/save'), 'class="form" id="formInputCarousel"') !!}

                                        <div class="col-md-12">
                                            <input type="hidden" name="id_carousel"
                                                value="{{ isset($carousel) && $carousel != null ? encode($carousel->id_carousel) : '' }}">

                                            <div class="form-group">
                                                <label>Judul Carousel</label>
                                                <textarea name="judul_carousel" id="judul_carousel" cols="50" rows="10"
                                                    class="ckeditor"
                                                    required>{{ isset($carousel) && $carousel != null ? $carousel->judul_carousel : '' }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="ket_carousel" id="ket_carousel" cols="50" rows="10"
                                                    class="ckeditor"
                                                    required>{{ isset($carousel) && $carousel != null ? $carousel->ket_carousel : '' }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file"
                                                    ...
                                                    style="height: unset"
                                                    data-default-file="{{ isset($carousel) && $carousel != null ? base_url('upload/slider/' . $carousel->file_carousel) : '' }}"
                                                    {{ isset($carousel) && $carousel != null ? '' : 'required' }} />
                                            </div>
                                        </div>
