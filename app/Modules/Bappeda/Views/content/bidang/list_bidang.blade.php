        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-3 col-12 mb-2">
                    <a href="{{ base_url('bappeda/bidang/add') }}" class="btn btn-block btn-info"><i
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td nowrap align="center">
                                                            <button type="button" onclick="showModal(this)"
                                                                data-judul="{{ $val->nama_bidang }}"
                                                                data-isi="{{ $val->ket_bidang }}"
                                                                data-icon="{{ $val->icon_bidang }}"
                                                                class="btn btn-sm btn-primary" title="Lihat Detail"><i
                                                                    class="la la-eye font-small-3"></i></button>
                                                            <a href="{{ base_url('bappeda/bidang/edit/' . encode($val->id_bidang)) }}"
                                                            ...
                                                            <button type="button" onclick="hapusData(this, true)"
                                                                data-link="{{ base_url('bappeda/bidang/delete/' . encode($val->id_bidang)) }}"
                                                        ...
                                                        <td align="center">
                                                            <input type="checkbox" class="switch" id="check_active"
                                                                ...
                                                                data-id="{{ encode($val->id_bidang) }}"
                                                                onchange="changeActive(this)"
                                                                {{ $val->active == 1 ? 'checked' : '' }} />
                                                        </td>
                                                        <td>{!! character_limiter($val->nama_bidang, 50, '...') !!}</td>
                                                        <td>{!! character_limiter($val->ket_bidang, 150, '...') !!}</td>
                                                        <td align="center">
                                                            <i class="{{ $val->icon_bidang }}"
...
@push('js_script')
    ...
    <script>
        function changeActive(data) {
            ...
            $.get("{{ base_url('bappeda/bidang/active/') }}/" + act + '/' + id,
                function(dt) {
