                    ...
                    <div class="dropdown float-md-right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
                            <a class="dropdown-item text-center"
                                href="{{ base_url('bappeda/pengabdian/dpmptsp/selesai?status=3') }}">Disetujui</a>
                            <a class="dropdown-item text-center"
                                href="{{ base_url('bappeda/pengabdian/dpmptsp/selesai?status=4') }}">Ditolak</a>
                            <a class="dropdown-item text-center"
                                href="{{ base_url('bappeda/pengabdian/dpmptsp/selesai?status=5') }}">Semua</a>
                        </div>
                    </div>
                </div>
...
@push('js_script')
    <script>
        showDataTable("{{ base_url('bappeda/pengabdian/dpmptsp/getdata/' . $status . '/tbl_data_rpb') }}",
            "{{ $status }}");
    </script>
    ...
    <script>
        ...
        function cetakSurat() {
            ...
            window.open("{{ base_url('bappeda/pengabdian/dpmptsp/cetak') }}?id=" + id + "&&idp=" + idp + "&&tgl=" + tgl);
            $('#modal_cetak').modal('hide');
        }
    </script>
@endpush

@include('content.pengabdian.dpmptsp.modal_detail')
