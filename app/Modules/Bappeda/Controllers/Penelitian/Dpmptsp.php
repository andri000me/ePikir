...
class Dpmptsp extends BaseController
{
    ...
    public function iplMasuk()
    {
        ...
        $this->v_data['active']     = '2.2.1';

        return views('content/penelitian/dpmptsp/ipl_masuk', 'Bappeda', $this->v_data);
    }

    public function iplProses()
    {
        $this->v_data['status']     = '2';
        $this->v_data['active']     = '2.2.2';

        return views('content/penelitian/dpmptsp/ipl_proses', 'Bappeda', $this->v_data);
    }
    ...
    public function iplSelesai()
    {
        ...
        $this->v_data['active']         = '2.2.3';

        return views('content/penelitian/dpmptsp/ipl_selesai', 'Bappeda', $this->v_data);
    }
    ...
    public function getDataIpl($status = 1, $table = '')
    {
        ...
        if ($post) {
            ...
            foreach ($fetch_data as $row) {
                ...
                data-link="' . base_url('bappeda/penelitian/dpmptsp/hapusdata/' . encode($row->id_user_pemohon)) . '" 
                data-table="' . $table . '" 
