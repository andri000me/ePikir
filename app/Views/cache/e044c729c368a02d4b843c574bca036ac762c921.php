        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Tugas Pokok</h3>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <?php echo form_open(base_url('bappeda/profil/tugaspokok/save'), 'class="form" id="formInputAbout"'); ?>


                                        <div class="form-group">
                                            <textarea name="tugas_pokok" id="ckeditor" class="ckeditor"
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/profil/tugaspokok.blade.php ENDPATH**/ ?>