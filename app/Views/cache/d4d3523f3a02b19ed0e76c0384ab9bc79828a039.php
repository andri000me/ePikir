...
<?php $__env->startPush('js_script'); ?>
    ...
    <script>
        ...
        function terimaPermohonan() {
            ...
            $(".loading-page").show();
            $('#modal_confirm').modal('hide');
            $.get("<?php echo e(base_url('dpmptsp/penelitian/setuju')); ?>/" + id,
                function(dt) {
        ...
        function tolakPermohonan() {
            ...
            $.post("<?php echo e(base_url('dpmptsp/penelitian/tolak')); ?>/" + id, {
                    message: msg
                },
                function(dt) {
                    var data = JSON.parse(dt);
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Dpmptsp\Views/content/penelitian/ipl_proses.blade.php ENDPATH**/ ?>