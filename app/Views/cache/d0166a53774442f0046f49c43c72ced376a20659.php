        ...
        <div class="content-wrapper">
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(base_url('bappeda/bidang')); ?>">Bidang</a></li>
                ...
                <div class="content-header-right col-md-2 col-12 mb-2">
                    <a href="<?php echo e(base_url('bappeda/bidang')); ?>" class="btn btn-block btn-primary"><i
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <?php echo form_open(base_url('bappeda/bidang/save'), 'class="form" id="formInputBidang"'); ?>


                                        <div class="col-md-12">
                                            <input type="hidden" name="id_bidang"
                                                value="<?php echo e(isset($bidang) && $bidang != null ? encode($bidang->id_bidang) : ''); ?>">

                                            <div class="form-group">
                                                <label>Nama Bidang</label>
                                                <textarea name="nama_bidang" id="nama_bidang" rows="2"
                                                    class="form-control textarea-maxlength" maxlength="50"
                                                    required><?php echo e(isset($bidang) && $bidang != null ? $bidang->nama_bidang : ''); ?></textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="ket_bidang" id="ket_bidang" rows="2"
                                                    ...
                                                    required><?php echo e(isset($bidang) && $bidang != null ? $bidang->ket_bidang : ''); ?></textarea>
                                            </div>
                                            ...
                                            <div class="form-group" style="display: flex;">
                                                ...
                                                <input type="text" name="icon_bidang" id="icon_bidang"
                                                    ...
                                                    value="<?php echo e(isset($bidang) && $bidang != null ? $bidang->icon_bidang : ''); ?>"
                                                    readonly>
                                                <div class="col-md-2">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="modal_body">
                    <?php echo $__env->make('content/bidang/icons', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
...
<?php $__env->startPush('js_plugin'); ?>
    ...
    <script src="<?php echo e(assets_url . 'app-assets/vendors/js/forms/extended/maxlength/bootstrap-maxlength.js'); ?>"></script>
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/bidang/form_bidang.blade.php ENDPATH**/ ?>