    ...
    <section id="hero-area" class="hero-area">
        ...
        <div class="slider-area">
            ...
            <?php $__currentLoopData = $carousel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="single-slider" style="background-image:url('<?php echo e(base_url('upload/slider/'.$item->file_carousel)); ?>')">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-md-6 col-12">
                                ...
                                <div class="slider-text">
                                    <div style="background:#ffffff94; padding: 20px">
                                        <h1><?php echo e($item->judul_carousel); ?></h1>
                                        <p><?php echo e($item->ket_carousel); ?></p>
                                    </div>
                ...
                <div class="col-lg-6 col-12 wow fadeInLeft" data-wow-delay="0.6s">
                    ...
                    <div class="about-video">
                        <div class="single-video overlay">
                            ...
                            <img src="<?php echo e(assets_front); ?>images/gallery-4.jpg" alt="#">
                        </div>
                    </div>
                    <!--/ End Video -->
                </div>
                            ...
                            <div class="cbp-item website animation printing">
                                <div class="portfolio-single">
                                    ...
                                    <div class="portfolio-hover">
                                        ...
                                        <div class="button">
                                            <a class="primary" data-fancybox="gallery" href="<?php echo e(assets_front); ?>images/portfolio/p1.jpg"><i
                            ...
                            <div class="cbp-item website animation">
                                <div class="portfolio-single">
                                    ...
                                    <div class="portfolio-hover">
                                        ...
                                        <div class="button">
                                            <a class="primary" data-fancybox="gallery" href="<?php echo e(assets_front); ?>images/portfolio/p3.jpg"><i
                                                    class="fa fa-search"></i></a>
                                            <a href="portfolio-single.html"><i class="fa fa-link"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="cbp-item development package">
                                <div class="portfolio-single">
                                    ...
                                    <div class="portfolio-hover">
                                        ...
                                        <div class="button">
                                            <a class="primary" data-fancybox="gallery" href="<?php echo e(assets_front); ?>images/portfolio/p5.jpg"><i
                                                    class="fa fa-search"></i></a>
                                            <a href="portfolio-single.html"><i class="fa fa-link"></i></a>
                                        </div>
                                    </div>
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Landing\Views/home.blade.php ENDPATH**/ ?>