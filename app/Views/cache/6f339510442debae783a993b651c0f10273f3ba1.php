                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <button type="button" onclick="hapusData(this, true)"
                                                                data-link="<?php echo e(base_url('kesbangpol/pejabat/delete/' . encode($item->id_petugas))); ?>"
    ...
    <div class="modal animated bounceIn text-left" id="modal_form" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php echo form_open(base_url('kesbangpol/pejabat/save'), 'id="form_input_pejabat"'); ?>
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Kesbangpol\Views/content/petugas/petugas.blade.php ENDPATH**/ ?>