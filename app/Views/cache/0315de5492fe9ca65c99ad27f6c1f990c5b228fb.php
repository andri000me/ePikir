                    ...
                    <div class="dropdown float-md-right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
                            <a class="dropdown-item text-center"
                                href="<?php echo e(base_url('bappeda/pengabdian/dpmptsp/selesai?status=3')); ?>">Disetujui</a>
                            <a class="dropdown-item text-center"
                                href="<?php echo e(base_url('bappeda/pengabdian/dpmptsp/selesai?status=4')); ?>">Ditolak</a>
                            <a class="dropdown-item text-center"
                                href="<?php echo e(base_url('bappeda/pengabdian/dpmptsp/selesai?status=5')); ?>">Semua</a>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('js_script'); ?>
    <script>
        showDataTable("<?php echo e(base_url('bappeda/pengabdian/dpmptsp/getdata/' . $status . '/tbl_data_rpb')); ?>",
            "<?php echo e($status); ?>");
    </script>
    ...
    <script>
        ...
        function cetakSurat() {
            ...
            window.open("<?php echo e(base_url('bappeda/pengabdian/dpmptsp/cetak')); ?>?id=" + id + "&&idp=" + idp + "&&tgl=" + tgl);
            $('#modal_cetak').modal('hide');
        }
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('content.pengabdian.dpmptsp.modal_detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/pengabdian/dpmptsp/ipb_selesai.blade.php ENDPATH**/ ?>