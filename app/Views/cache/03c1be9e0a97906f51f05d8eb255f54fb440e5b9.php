        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div id="modal_header" class="modal-header bg-primary">
                    <h4 class="modal-title white" id="modal_title">Detail Permohonan Izin Pengabdian Masyarakat</h4>
...
<?php $__env->startPush('js_script'); ?>
    <script>
        function showDetailModal(data) {
            ...
            var list = "<tr> <th> Nomor </th> <td>" + noipb + "</td> </tr>" +
            ...
            // var lampiran = '<iframe src="<?php echo e(base_url('upload/permohonan/ipb')); ?>/' + file +
            //     '" style = "width:100%; height:80vh;" frameborder = "0" > < /iframe>';

            var embed =
                '<iframe src="https://docs.google.com/gview?url=<?php echo e(base_url('upload/permohonan/ipb')); ?>/' + file +
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/pengabdian/dpmptsp/modal_detail.blade.php ENDPATH**/ ?>