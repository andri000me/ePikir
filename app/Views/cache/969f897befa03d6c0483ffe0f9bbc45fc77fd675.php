<!-- Berita Terikini -->
<section class="blogs-main portfolio section">
    <div class="container">
        <div class="row">
            <div class="col-12 wow fadeInUp">
                <div class="section-title">
                    <span class="title-bg">Artikel</span>
        ...
        <div class="row">
            <div class="col-12">
                <div class="button">
                    <a class="btn primary" href="portfolio-3-column.html">Lihat Semua Berita</a>
                </div>
            </div>
        </div>
    </div>
...
<!--/ End Berita Terikini -->
<?php /**PATH D:\PROJECT\CODE IGNITER 4\epikir_new\app\Modules\Landing\Views/content/beranda/berita.blade.php ENDPATH**/ ?>