        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Kategori Galeri</h3>
                ...
                <div class="content-header-right col-md-3 col-12 mb-2">
                    <a href="<?php echo e(base_url('bappeda/kategorigaleri/add')); ?>" class="btn btn-block btn-info"><i
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered" id="list_tbl">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $kg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td align="center" width="50"><?php echo e($key + 1); ?></td>
                                                        <td nowrap align="center" width="100">
                                                            <a href="<?php echo e(base_url('bappeda/kategorigaleri/edit/' . encode($val->id_kg))); ?>"
                                                            ...
                                                            <button type="button" onclick="hapusData(this, true)"
                                                                data-link="<?php echo e(base_url('bappeda/kategorigaleri/delete/' . encode($val->id_kg))); ?>"
                                                        ...
                                                        <td align="center" width="100">
                                                            <input type="checkbox" class="switch" id="check_active"
                                                                ...
                                                                data-id="<?php echo e(encode($val->id_kg)); ?>"
...
<?php $__env->startPush('js_script'); ?>
    ...
    <script>
        function changeActive(data) {
            ...
            $.get("<?php echo e(base_url('bappeda/kategorigaleri/active/')); ?>/" + act + '/' + id,
                function(dt) {
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/kategorigaleri/list_kg.blade.php ENDPATH**/ ?>