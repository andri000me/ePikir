                    ...
                    <div class="dropdown float-md-right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
                            <a class="dropdown-item text-center"
                                href="<?php echo e(base_url('bappeda/penelitian/dpmptsp/selesai?status=3')); ?>">Disetujui</a>
                            <a class="dropdown-item text-center"
                                href="<?php echo e(base_url('bappeda/penelitian/dpmptsp/selesai?status=4')); ?>">Ditolak</a>
                            <a class="dropdown-item text-center"
                                href="<?php echo e(base_url('bappeda/penelitian/dpmptsp/selesai?status=5')); ?>">Semua</a>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('js_script'); ?>
    ...
    <script>
        ...
        function cetakSuratRpl() {
            ...
            window.open("<?php echo e(base_url('bappeda/penelitian/dpmptsp/cetak')); ?>?id=" + id + "&&idp=" + idp + "&&tgl=" + tgl);
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/penelitian/dpmptsp/ipl_selesai.blade.php ENDPATH**/ ?>