                      ...
                      <div class="single-sidebar post-tab">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="perBulan" role="tabpanel">
                                ...
                                <div class="timeline"> 
                                    ...
                                    <?php $__currentLoopData = $agenda_bln; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="timeline__event animated wow <?php echo e($fade); ?> timeline__event--<?php echo e($type); ?>" data-wow-delay="<?php echo e($jml_agenda); ?>s">
                                            <div class="timeline__event__icon ">
                                            <i class="fa fa-calendar-check-o"></i>
                                            </div>
                                            <div class="timeline__event__date">
                                            <?php echo e(date('d/m/Y', strtotime($item->waktu_awal)) == date('d/m/Y', strtotime($item->waktu_akhir))?date('d/m/Y', strtotime($item->waktu_awal)):date('d/m/Y', strtotime($item->waktu_awal)).' - '.date('d/m/Y', strtotime($item->waktu_akhir))); ?>
                                            ...
                                            <div class="timeline__event__description">
                                                <p><?php echo e($item->isi_agenda); ?></p>
                                            </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade show" id="perTahun" role="tabpanel">
                                ...
                                <iframe src="<?php echo e(base_url('landing/calendar')); ?>" style="width:100%; height:115vh;" frameborder="0" ></iframe>
                            </div>
