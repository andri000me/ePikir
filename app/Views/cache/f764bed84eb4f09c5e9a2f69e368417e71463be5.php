        ...
        <div class="content-wrapper">
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(base_url('bappeda/profil/regulasi')); ?>">Regulasi
                                        Kelitbangan</a></li>
                ...
                <div class="content-header-right col-md-2 col-12 mb-2">
                    <a href="<?php echo e(base_url('bappeda/profil/regulasi')); ?>" class="btn btn-block btn-primary"><i
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <?php echo form_open_multipart(base_url('bappeda/profil/regulasi/save'), 'class="form" id="formInputRegulasi"'); ?>


                                        <div class="col-md-12">
                                            <input type="hidden" name="id_regulasi"
                                                value="<?php echo e(isset($regulasi) && $regulasi != null ? encode($regulasi->id_regulasi) : ''); ?>">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_regulasi" class="form-control"
                                                    ...
                                                    value="<?php echo e(isset($regulasi) && $regulasi != null ? $regulasi->nama_regulasi : ''); ?>"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="isi_regulasi" class="form-control"
                                                    ...
                                                    value="<?php echo e(isset($regulasi) && $regulasi != null ? $regulasi->isi_regulasi : ''); ?>"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="file" data-validation-required-message="Upload file lampiran"
                                                    ...
                                                    style="height: unset"
                                                    data-default-file="<?php echo e(isset($regulasi) && $regulasi != null ? base_url('upload/regulasi/' . $regulasi->file_regulasi) : ''); ?>"
                                                    <?php echo e(isset($regulasi) && $regulasi != null ? '' : 'required'); ?> />
                                            </div>
                                        </div>
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/regulasi/form_regulasi.blade.php ENDPATH**/ ?>