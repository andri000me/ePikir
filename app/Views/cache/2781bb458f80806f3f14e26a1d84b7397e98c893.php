                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8 col-12">
                                                            <div class="form-main">
                                                                ...
                                                                <?php echo form_open_multipart(base_url('landing/izinpenelitian/saverpl'), 'class="form" id="formInputRp"'); ?>
...
<?php $__env->startPush('js_script'); ?>
    ...
    <script>
        function getToken() {
            ...
            if (check_valid) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(base_url('landing/gettoken')); ?>",
                    dataType: "json",
                    data: {
                        no_hp: no_hp
                    },
    ...
    <script>
        ...
        function saveData() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(base_url('landing/izinpenelitian/saverpl')); ?>",
                dataType: "json",
                processData: false,
                contentType: false,
                data: formData,
