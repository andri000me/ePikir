                            ...
                            <div class="row nothing" style="padding-top: 31px;">
                                ...
                                <div class="col-md-4">
                                    <div class="button" style="margin-top: 0px;">
                                        <a class="btn primary w-100 float-right" href="<?php echo e(base_url('landing/berita')); ?>" style="margin-bottom: -12px;">Lihat Semua Berita</a>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                                    ...
                                    <div class="single-blog">
                                        ...
                                        <div class="blog-bottom">
                                            <div class="blog-inner">
                                                ...
                                                <div class="meta">
                                                    <span><i class="fa fa-bullhorn"></i><a href="<?php echo e(base_url('landing/berita?kategori=' . encode($item->id_kb))); ?>"><?php echo e($item->nama_kategori); ?></a></span>
                                                    <span><i class="fa fa-calendar"></i><?php echo e(formatTanggalTtd($item->waktu_update)); ?></span>
                        ...
                        <div class="row nothing">
                            <div class="col-lg-12 col-12 text-center">
                                <div class="shadow p-3 bg-white rounded"
                                    ...
                                    <h5 class="font-italic"><i class="fa fa-newspaper-o"></i> <?php echo e($search != null ? 'Berita/artikel yang dicari tidak ditemukan.' : 'Belum ada berita/artikel yang diposting.'); ?> </h5>
                                    <?php if($search != null): ?>
                                        <div class="button">
