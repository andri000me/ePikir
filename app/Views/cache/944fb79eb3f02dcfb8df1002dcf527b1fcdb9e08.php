        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div id="modal_header" class="modal-header bg-primary">
                    <h4 class="modal-title white" id="modal_title">Detail Permohonan Rekomendasi Pengabdian Masyarakat</h4>
...
<?php $__env->startPush('css_style'); ?>
    <style>
        #modal_detail #tbl_detail_rpb thead tr th {
            vertical-align: top;
        }
...
<?php $__env->startPush('js_script'); ?>
    <script>
        function showDetailModal(data) {
            ...
            var list = "<tr> <th> Nomor </th> <td>" + norpb + "</td> </tr>" +
                "<tr> <th> Nama Ketua Regu </th> <td>" + nama + "</td> </tr>" +
                ...
                "<tr> <th> Lokasi Kegiatan</th> <td>" + lokasi + "</td> </tr>" +
                "<tr> <th> Tujuan </th> <td>" + tujuan + "</td> </tr>" +
                "<tr> <th> Tanggal Pelaksanaan </th> <td>" + tglpelaksana + "</td> </tr>" +
                "<tr> <th> Waktu Pengajuan </th> <td>" + pengajuan + "</td> </tr>";

            // var lampiran = '<iframe src="<?php echo e(base_url('upload/permohonan/rpb')); ?>/' + file +
            //     '" style = "width:100%; height:80vh;" frameborder = "0" > < /iframe>';

            var embed =
                '<iframe src="https://docs.google.com/gview?url=<?php echo e(base_url('upload/permohonan/rpb')); ?>/' + file +
                '&embedded=true" style = "width:100%; height:80vh;"></iframe>';

            $('#modal_detail #tbl_detail_rpb thead').html(list);
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/pengabdian/kesbangpol/modal_detail.blade.php ENDPATH**/ ?>