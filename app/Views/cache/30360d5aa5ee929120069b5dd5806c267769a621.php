        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Permohonan Proses</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Permohonan Proses</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('js_script'); ?>
    ...
    <script>
        ...
        function terimaPermohonan() {
            ...
            $(".loading-page").show();
            $('#modal_confirm').modal('hide');
            $.get("<?php echo e(base_url('bappeda/pengabdian/dpmptsp/setuju')); ?>/" + id,
                function(dt) {
        ...
        function tolakPermohonan() {
            ...
            $.post("<?php echo e(base_url('bappeda/pengabdian/dpmptsp/tolak')); ?>/" + id, {
                    message: msg
                },
                function(dt) {
                    var data = JSON.parse(dt);
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/pengabdian/dpmptsp/ipb_proses.blade.php ENDPATH**/ ?>