        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-3 col-12 mb-2">
                    <a href="<?php echo e(base_url('bappeda/publikasi/agenda/add')); ?>" class="btn btn-block btn-info"><i
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered" id="list_tbl">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $agenda; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td align="center"><?php echo e($key + 1); ?></td>
                                                        <td nowrap align="center">
                                                            <a href="<?php echo e(base_url('bappeda/publikasi/agenda/edit/' . encode($val->id_agenda))); ?>"
                                                            ...
                                                            <button type="button" onclick="hapusData(this, true)"
                                                                data-link="<?php echo e(base_url('bappeda/publikasi/agenda/delete/' . encode($val->id_agenda))); ?>"
                                                                class="btn btn-sm btn-danger" title="Hapus Data"><i
                                                                    class="la la-trash-o font-small-3"></i></button>
                                                        </td>
                                                        <td nowrap><?php echo e($val->judul_agenda); ?></td>
                                                        <td><?php echo e($val->isi_agenda); ?></td>
                                                        <td nowrap align="center">
                                                            <?php echo e(formatTanggal($val->waktu_awal, false, true)); ?></td>
                                                        <td nowrap align="center">
                                                            <?php echo e(formatTanggal($val->waktu_akhir, false, true)); ?></td>
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\xampp\htdocs\epikir_new\app\Modules\Bappeda\Views/content/agenda/agenda.blade.php ENDPATH**/ ?>